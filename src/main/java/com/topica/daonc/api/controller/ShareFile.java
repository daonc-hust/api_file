...
public class ShareFile {
    ...
    public ShareFile() throws IOException, GeneralSecurityException {
    }

    @GetMapping("/share_file")
    public String shareFile(@RequestParam String id, @RequestParam String email, @RequestParam String role) throws IOException {
